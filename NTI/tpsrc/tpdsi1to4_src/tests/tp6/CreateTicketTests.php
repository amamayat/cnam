...
class CreateTicketTests extends AbstractCommonWebTest {
	...
	function notatestgetProjectRootUrl() {
		$createTicketURL = $this->getProjectRootUrl() . 'tp6/editTicket.php';
		$expectedCreateTicketURL = 'http://localhost:80/tpdsi/tp6/editTicket.php';
	...
	function createAppNameFile($file) {
		...
		$apps = <<<EOT
1;    Paye;paye@cnam.fr
2;Inscriptions ;insc@cnam.fr
3;  Achats;achats@cnam.fr
4;Messagerie	;msg@cnam.fr	
EOT;
		fwrite($f, $apps);
		fclose($f);
	}
